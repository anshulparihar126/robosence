                ...
                touchMove: function(s) {
                    if (r && (P = s.targetTouches[0], !b && !S)) {
                        ...
                        if (Math.abs(u) > Math.abs(m) ? (L = !1,
                            ...
                            I && (h = 1 - Math.abs(t) / l,
                                g.style.opacity = h,
                                e.settings.touchFollowAxis && (A = 0)), !f)
    ...
    function F(e, t, i, n) {
        ...
        r.style.maxWidth = t.width,
            S(this.settings.plyr.js, "Plyr", (function() {
                if (!u && c.match(/vimeo\.com\/([0-9]*)/) && (u = "vimeo"), !u && (c.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || c.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/)) && (u = "youtube"),
                    "local" === u || !u) {
                    u = "local";
                    var l = '<video id="' + o + '" ';
            ...
            return n(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        if ("a" === h && (r = e.href),
                            ...
                            n.content && (n.type = "inline"), !n.type && r && (n.type = this.sourceType(r)),
                            I(a)) {
                            if (!n.title && "a" == h) {
                                var d = e.title;
                                I(d) || "" === d || (n.title = d)
            ...
            return n(e, [{
                    ...
                    value: function() {
                        ...
                        if (this.prevActiveSlide = this.activeSlide,
                            this.prevActiveSlideIndex = this.index, !this.loop() && (e < 0 || e > this.elements.length - 1))
                            return !1;
